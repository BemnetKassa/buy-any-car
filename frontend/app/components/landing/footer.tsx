...
export default function LandingFooter() {
	return (
		<footer className="w-full py-12 bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800 text-center text-gray-500 dark:text-gray-400">
			<div className="max-w-7xl mx-auto px- sm:px-4 lg:px-6 flex flex-col md:flex-row items-center justify-between gap-6 mb-4">
				...
				<div className="flex gap-6">
					<a href="/landingPage/dashboard" className="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition">Home</a>
			...
			<div className="border-t border-gray-100 dark:border-gray-900 pt-6 text-sm">
